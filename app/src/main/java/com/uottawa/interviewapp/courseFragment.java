...
class courseFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstancesState){
        ...
        rootView = inflater.inflate(R.layout.course_view, container,
                false);
        ...
        courseImage = (ImageView) rootView.findViewById(R.id.courseImage);
        ...
        title  = (TextView) rootView.findViewById(R.id.courseTitle);

        titleTag  = (TextView) rootView.findViewById(R.id.courseTitleTag);
        ...
        description  = (TextView) rootView.findViewById(R.id.courseDescription);

        descriptionTag  = (TextView) rootView.findViewById(R.id.courseDescriptionTag);

        descriptionTag.setTypeface(sanFranBolder);


        description.setTypeface(sanFranMedium);

        if(getArguments().getString("description").length() >= 45){
            description.setText(" "+getArguments().getString("description").substring(0,45) + "...");
        }
    ...
    class RetrieveFeedTask extends AsyncTask<String, Void, Drawable> {
        ...
        protected void onPostExecute(Drawable x) {
            courseImage.setImageDrawable(x);
        }
    }
}
